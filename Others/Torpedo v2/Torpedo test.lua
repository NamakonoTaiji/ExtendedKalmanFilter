...
local INITIAL_GUIDANCE_TICKS, INITIAL_GUIDANCE_DURATION_SECONDS, FUSE_PROXIMITY_DURATION_TICKS, VT_FUSE_SAMPLING_TICKS
-- 定数
PI = math.pi
PI2 = PI * 2
DT = 1 / 60
...
function onTick()
    ...
    if isLaunch then
        ...
        dataLinkY = math.max(input.getNumber(8), 0)
