...
function onTick()
    ...
    if isGuidanceStart then
        ...
        if initialGuidanceCounter > 120 then
            isPPN = false
        end
    end
    ...
    ----------------------------------------------------------------------------
    if isAntiShipMode and isGuidanceStart then
    ...
    if distance + approach_Velocity * 3 < 150 and not isAntiShipMode and isLaunched then
        missileRadarIO = true
    end
